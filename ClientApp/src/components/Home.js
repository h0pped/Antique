        ...
        <div className="topics-div has-text-centered ">
          ...
          <div className="columns is-mobile">
            <div className="column  is-one-third-mobile is-one-third-tablet is-one-third-desktop is-one-third-widescreen is-one-third-fullhd">
              ...
              <div className="topic">
                ...
                <div className="topics-text" >
                  <p className="is-size-5 has-text-white">Комоды и шкафы</p>
                </div>
              </div>
              </Link>
            </div>
            ...
            <Link to="/МягкаяЧасть">
              ...
              <div className="topic">
                ...
                <div className="topics-text" >
                  <p className="is-size-5 has-text-white">Мягкая часть</p>
                </div>
              </div>
              </Link>
            </div>
            <div className="column is-one-third-mobile is-one-third-tablet is-one-third-desktop is-one-third-widescreen is-one-third-fullhd">
              ...
              <div className="topic">
                ...
                <div className="topics-text" >
                  <p className="is-size-5 has-text-white">Столы и стулья</p>
                </div>
              </div>
              </Link>
            </div>
          ...
          <div className="column is-one-third-mobile is-one-third-tablet is-one-third-desktop is-one-third-widescreen is-one-third-fullhd">
              ...
              <div className="topic">
                ...
                <div className="topics-text" >
                  <p className="is-size-5 has-text-white">Часы</p>
                </div>
              </div>
              </Link>
            </div>
            <div className="column is-one-third-mobile is-one-third-tablet is-one-third-desktop is-one-third-widescreen is-one-third-fullhd">
             <Link to="/Разное">
              <div className="topic">
                ...
                <div className="topics-text" >
                  <p className="is-size-6 has-text-white topics-p">Разное</p>
                </div>
              </div>
             </Link>
            </div>
            <div className="column is-one-third-mobile is-one-third-tablet is-one-third-desktop is-one-third-widescreen is-one-third-fullhd">
              ...
              <div className="topic">
                ...
                <div className="topics-text" >
                  <p className="is-size-5 has-text-white">Статус заказа</p>
                </div>
              </div>
            </Link>
            </div>
